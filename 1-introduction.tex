...
the field.  This interpretation follows from taking the EM field Hamiltonian to be 
\begin{equation}
...
The energy can also be recast as 
\begin{equation}
  E = \sum_k \frac{\hbar\omega_k}{2}\left(\op{a}^\dag_k \op{a}_k + \op{a}_k\op{a}^\dag_k\right),
\end{equation}
where the second term can be interpreted as spontaneous emission and re-absorption
of a photon.
