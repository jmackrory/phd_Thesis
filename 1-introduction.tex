...
Following \citet[\S3.12]{Milonni1994} % (\S3.12 in Ref.~\citep{Milonni1994})
...
on itself is repulsive.  In this case, a great deal of care is required in isolating 
...
This surprising result has been verified multiple times [the issue of self-stresses
 is reviewed in \citet{Milton2011}, and Chapters 5 and 6 of \citet{Milton2004}].
The repulsive Casimir effect is also true for a dielectric sphere.  
While the stress on a spherical shell is repulsive, the force between two spherical half-shells is attractive.  
This self-stress has not been directly measured, nor is it clear how it could be measured.  
...
is based on scattering techniques from classical EM theory and quantum mechanics. %.~\citep{Rahi2009}.
...
The Heat Kernel examines the divergence structure of a field theory by examining the short time behaviour of the 
worldline.  
...
The worldline method has also been extended to non-zero temperatures \citep{Klingmueller2008}.
...
% In Chapter~\ref{ch:general} we will discuss the prospects for a general method based on the current
...
% In Chapter~\ref{ch:trajectory} we change topic to discussing continuous position measurements 
