...
As it stands this expression is divergent, but we can find finite results by subtracting off the 
free energy when the bodies removed to spatial infinity.  Physically this corresponds to 
...
Second, we will use the integral representation of the logarithm,
\begin{equation}
