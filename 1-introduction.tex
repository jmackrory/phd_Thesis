...
Each path is weighted with a phase $e^{iS[x(t)]/\hbar}$ where $S[x(t)]$ is the classical action for the path.
    ...
    \begin{equation}
      \langle x_f,t_f| x_i, t_0\rangle = \langle x_f| e^{-\frac{i}{\hbar}\op{H}t}|x_i\rangle.
    \end{equation}
    For a particle in a potential $V(\vect{x})$, the Hamiltonian is 
    \begin{equation}
    ...
    \begin{gather}
      I = \int d^Dx |\vect{x}\rangle\langle\vect{x}| = \int d^Dp |\vect{p}\rangle\langle\vect{p}|,
    \end{gather}
    and overlap
    \begin{equation}
      \langle \vect{x}|\vect{p}\rangle = \exp\left[\frac{i}{\hbar}\vect{x}\cdot\vect{p}\right].
    \end{equation}
