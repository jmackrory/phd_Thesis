...
\begin{enumerate}
  ...
  \item  Stochastic Schr\"odinger equation
    \begin{equation}
      ...
      + \left(\frac{\sigma|\psi\rangle}{\langle \sigma^\dag\sigma\rangle^{1/2}}-|\psi\rangle dN
      \end{equation}
    where $dN$ is Poisson process with mean
    \begin{equation}
      \dlangle dN\drangle = \Gamma \langle \sigma^\dag\sigma\rangle dt
    \end{equation}
    Note that using $\dlangle\cdots\drangle$ for ensemble average over stochastic processes,
