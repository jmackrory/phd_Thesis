...
At the other limit, for distances beyond $10 \mu$m, the Casimir effect is too weak to detect.  
...
However, for any method it is useful to have alternative methods with different computational properties
