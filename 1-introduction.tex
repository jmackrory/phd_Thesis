...
\end{equation}
where $\mathbf{M}$ is a matrix where the entires encode the scattering between various surface current 
...
arbitrarily far apart.  It removes the energy from any self-interactions of the bodies with themselves.
