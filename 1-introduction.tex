...
with the quantized electromagnetic (EM) field, even if the EM field is in its vacuum state~\cite{Casimir1948}.  
...
interaction with the quantized EM field~\cite{Casimir1948}.
...
one another via their interaction with the quantized EM field~\cite{Casimir1948}.  
...
mediated via the EM field~\cite{Jaffe2005, Rahi2009}.  This picture is also
...
is based on scattering techniques from classical EM theory and quantum mechanics~\cite{Rahi2009}.
