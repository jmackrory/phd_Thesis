...
Finally, the development was initially focused on Casimir energies, with no simple way to 
extract Casimir--Polder type energies. 
...
electromagnetism~\cite{Aehlig2011}.  Somewhat related are direct attempts to evaluate
the functional determinants by explicitly discretizing the operators
