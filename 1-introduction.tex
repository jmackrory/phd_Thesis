...
These requirements force one to adopt a general numerical approach to computing Casimir forces~\cite{Johnson2009}.
...
(as a quick justification, the Casimir energy
depends on $\langle H\rangle$ which is quadratic in the fields.  However, in the case of the Casimir-Polder energy one might
be able to focus on the linear change)
