...
We will develop analytical and numerical methods in Chapter~\ref{ch:analytical} and \ref{ch:numerical}, 
showing agreement with known electromagnetic Casimir results.
% In Chapter~\ref{ch:general}, we discuss the prospects for a general method based on coupling the scalar polarizations
...
(The scattering approach which will be briefly discussed in Sec.~\ref{sec:scattering}.)  Only bodies
