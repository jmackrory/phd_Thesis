...
\todo{Variable transformations?  $k$ $\cos\theta?$?}
...
\todo{Barton on surface modes, which are exponential decays.}
...
for two-body systems such as spheres and planes~\cite{Canaguier-Durand2012}.  Instead of reflection
