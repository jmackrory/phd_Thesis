...
Quantum field theories are the basis for our modern descriptions of fundamental physics.  
...
Interactions are mediated by exchanging quanta of the appropriate field.
...
A consequence of this idea of exchanging quanta is that it provides the opportunity for forces, 
even when there are no directly physically observable quanta.  While it is expected that charged 
particles would be attracted to one another via photon emission (leading to the familiar Coulomb interaction),
the surprising feature of this picture is that it leads to forces even for neutral bodies.
A pair of electrically neutral, conducting bodies will be attracted to one another due to their interaction
with quantized electromagnetic fields, even in the absence of external photons~\cite{Casimir1948}---this is
the Casimir effect.  
