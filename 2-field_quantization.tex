...
The worldline path integral for the four-potential treatment of the EM field can be computed straightforwardly
...
\begin{align}
  ...
  &-2\big[\exp(-M_\text{g}\cT) - \exp(-M\sup0\cT)\big]\bigg\}
\end{align}
