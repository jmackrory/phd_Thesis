...
Our work on the EM path integral will closely parallel Bordag\etal's work, with some difference in aims.
...
The $\vect{E}$ and $\vect{B}$ fields can be rewritten in terms of the scalar $A_0(\vect{r},t)$ and vector potential
$\vect{A}(\vect{r},t)$:
\begin{align}
...
% \end{align}
Since $\Pi_0$ is constrained to vanish, the $\Pi_0$ integrals can be carried out immediately.
...
\begin{multline}
\langle \phi_{\beta+d\beta}\vect A_{\beta+d\beta}| e^{-d\beta \hat{H}}|\phi_\beta, \vect A_\beta\rangle\\
%  \int\! d\vect{\Pi}_\beta \exp\left[ -d\beta\int d^3r \frac{\vect{\Pi}_\beta^2}{2\epsilon_0\epsr(\vect{r})} 
...
Rosa\etal\cite{Rosa2009}.  As noted earlier, Rahi\etal derived their effective Lagrangian at finite
