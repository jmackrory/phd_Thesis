...
is attended by noise, either as decoherence terms in the master equation or as noise terms in the Langevin equations for the operators~\citep{GardinerZoller2004}}.
...
[A parallel treatment of the Hamiltonian treatment of EM is given by  \citet[\S8.8]{SteckNotes}.]
...
% \end{equation}
% (For the example of QED in free space see ~\citet{Dirac1966}, or \citet[\S7.6]{WeinbergQFT1}.)
...
For example see \citet[\S9.4]{Peskin1995}, or ~\citet[\S 71]{Srednicki2008}}  
...
\begin{align}
 ...
 \exp\left(-S_E-\int d\vect{r}d\tau\, \frac{\gamma^2}{2\xiFP}\right)\nonumber\\
 &= \int D\vect{A} DA_4\det\bigg(\frac{\delta G}{\delta \alpha} \bigg)
 \exp\left(-S_E-\int d\vect{r}d\tau\, \frac{G^2}{2\xiFP}\right),
\end{align}
...
The resulting computations can proceeding using homogeneous formulae for all quantities and ignoring any singularities 
...
which is closely allied with the worldline method~\citep{Elizalde2008}.
...
It may be possible that we have not made an error, and this complicated set of path integrals conspires to yield the correct answer.
...
The nonzero-temperature TE worldline path integral can be developed as before.  However,
...
% based on the approach of deriving the dielectric via linear response theory advocated in \citet{Rosa2008}.
