...
However, the resulting worldline path integrals for the vector potentials pose a number of challenges.
...
the unphysicalscalar and longitudinal photons do not cancel the gauge-fixing or ``ghost'' determinant, as happens in 
vacuum.  
...
\end{align}
Note that the remaining Maxwell equationscan be derived from this Lagrangian.  
