...
quantize the EM field in Section~\ref{sec:EM_quantization}, and develop the EM partition function in 
Section~\ref{sec:EM_partition}.
...
in Section~\ref{sec:gauge_path_integral}.
However, the resulting worldline path integrals~(\ref{eq:vector_path_integral}) pose a number of challenges, as 
it is not clear how the two physical contributions emerge from these complicated expressions.. 
