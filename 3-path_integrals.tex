...
Beyond the results, we can also consider a dielectric step combined with a TM boundary condition.  
This is directly relevant to analytically computing the TM component of the Casimir--Polder energy for an atom near a
dielectric half-space.  In this case we only require the results for closed paths.  
   ...
   {Leave as Laplace-transform.  Note integral identities mean we can apply this for analytical
    result analytically.  }
  \begin{equation}
