...
This connects the path integral with other tools used in physics to describe stochastic processes~\cite{Gardiner2010}.
...
Note that this labelling is backwards in time from the usual convention, but it 
...
\end{align}
This agrees with the results of the more formal methods presented in Durrett~\cite{Durrett1995}, and Steck~\cite{SteckNotes}.
This result was derived under the assumption that the potential is independent of time.  
