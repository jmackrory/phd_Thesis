...
The worldline path integral also involves a highly singular potential~(\ref{eq:VsubTM2}), and in Section~\ref{sec:TM_potential}
...
In sections~\ref{sec:TM_onebody_FK} and \ref{sec:TM_twobody_FK}, 
we derive analytical TM path integrals that include the TM potential, as well as a step-potential
which models the dielectric average.  These results are given in Eqs.~(\ref{eq:Feynman-Kac TM one step})
