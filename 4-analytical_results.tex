...
In this limit the worldline Casimir energy for both polarization is
\begin{align}
    ...
    E\subTM-E\sup0 = -\frac{\hbar c}{2}\int_0^\infty\frac{d\cT}{(2\pi\cT)^{D/2}\cT}\int d\vect{x}_0
    \biggdlangle
...
\begin{align}
\int_0^\infty \frac{d\cT}{\cT^{1+z}}e^{-s\cT}\dlangle e^{-s \chi\int_0^\cT dt\,\Theta(x-d)}\drangle 
