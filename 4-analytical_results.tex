...
\begin{align}
    \frac{E\subTE-E\sup0}{A}
  &= -\frac{\hbar c}{8\pi^2}\int_0^\infty dt \,t^{3}  \int_1^\infty dv\, (v^2-1) \frac{d}{dv}\bigg[\frac{1}{t}\log(1-u\supTE_1u\supTE_2 e^{-2tvd})\bigg]\\
...
-\big(f\supTM_{2}(\vect{x}_0)-f_{1}\sup0\big)\right],
  \end{align}
where this time the solutions are the path integrals in Eqs.~(\ref{eq:Feynman-Kac TM one step}) and 
(\ref{eq:Feynman-Kac TM two step}).
The spatial integrals over $x_0$ can be evaluated, and the results simplified.  This algebra is again
deferred to an App.~\ref{nasty_calc}.
...
\begin{align}
I_{tot}=&  \frac{e^{-2\sqrt{2\lambda}d}}{(1-u\supTM_1u\supTM_2e^{-2\sqrt{2\lambda}d}}\left[
 \frac{2u\supTM_1u\supTM_2d}{\sqrt{2\lambda}}+ \dfrac{u\supTM}{2\kappa}  -\frac{ u\supTM}{2\lambda} 
- \left(\frac{u\supTM}{2\kappa}-\frac{u\supTM}{2\lambda}\right)u\supTM_1u\supTM_2\right]\\
=&  \frac{e^{-2\sqrt{2\lambda}d}}{(1-u\supTM_1u\supTM_2e^{-2\sqrt{2\lambda}d}}\left[
\frac{2u\supTM_1u\supTM_2d}{\sqrt{2\lambda}}+ \frac{u\supTM}{2}(1-u\supTM_1u\supTM_2)\left(\dfrac{1}{\kappa}  -\frac{1}{\lambda}\right)\right],
\end{align}
...
% &\times  \frac{e^{-2\sqrt{2(\lambda+s)}d}}{1-u\supTM^2e^{-2\sqrt{2(\lambda+s)}d}}
% \left[\frac{2u\supTM^2d}{\sqrt{2(\lambda+s)}}+ \frac{u\supTM}{2}(1-u\supTM^2)\left(\dfrac{1}{\lambda+s+s\chi}  -\frac{1}{\lambda+s}\right)\right],
% \end{align}
% and 
% \begin{equation}
% u\supTM =  \frac{(1+\chi)\sqrt{\lambda+s}-\sqrt{\lambda+ s + s\chi}}{(1+\chi)\sqrt{\lambda+s}+\sqrt{\lambda+s+s\chi}},
% \end{equation}
% \begin{equation}
...
% &\times  \frac{e^{-2\sqrt{2(q+1)s}d}}{1-u\supTM^2e^{-2\sqrt{2(q+1)s}d}}\left[
% \frac{2u\supTM^2d}{\sqrt{2s(q+1)}}+ \frac{u\supTM}{2}(1-u\supTM^2)\left(\dfrac{1}{s(q+1+\chi)}  -\frac{1}{s(q+1)}\right)\right],
% \end{align}
% and 
% \begin{equation}
% u\supTM =  \frac{(1+\chi)\sqrt{q+1}-\sqrt{q+ 1 + \chi}}{(1+\chi)\sqrt{q+1}+\sqrt{q+1+\chi}},
% \end{equation}
...
% % &\times  \frac{e^{-2\sqrt{2s}pd}}{1-u\supTM^2e^{-2\sqrt{2s}pd}}\left[\frac{2u\supTM^2d}{\sqrt{2s}p}+ 
% % \frac{u\supTM}{2}(1-u\supTM^2)\left(\dfrac{1}{s(p^2+\chi)}  -\frac{1}{s p^2}\right)\right]\\
% =&  2C\int_1^\infty dp (p^2-1)^{(D-1)/2-\alpha}\int_0^\infty ds\, s^{(D-1)/2}\nonumber\\
% &\times\frac{e^{-2\sqrt{2s}pd}}{1-u\supTM^2e^{-2\sqrt{2s}pd}}\left[\frac{2u\supTM^2d}{\sqrt{2s}}- 
% \frac{u\supTM}{2}(1-u\supTM^2)\left(\dfrac{\chi}{s(p^2+\chi)p}\right)\right],
% \end{align}
% and 
% \begin{equation}
% u\supTM =  \frac{(1+\chi)p-\sqrt{p^2 + \chi}}{(1+\chi)p+\sqrt{p^2+\chi}},
% \end{equation}
\item Finally, take 
$s = \xi^2$
\item Now take $p = \sqrt{q+1}$.  $\rightarrow  q = p^2-1, dq = 2p dp$.  
...
% &\times  \frac{e^{-2\sqrt{2}\xi pd}}{1-u\supTM^2e^{-2\sqrt{2}\xi pd}}\left[\frac{2u\supTM^2d}{\sqrt{2}\xi}-
%  \frac{u\supTM}{2}(1-u\supTM^2)\left(\frac{ \chi}{\xi^2(p^2+\chi)p}\right)\right]\\
=&  4C\int_1^\infty dp (p^2-1)^{(D-1)/2-\alpha}\int_0^\infty d\xi\,\xi^{D-1}\nonumber\\
&\times  \frac{u\supTM_1u\supTM_2e^{-2\sqrt{2}\xi pd}}{1-u\supTM_1u\supTM_2e^{-2\sqrt{2}\xi pd}}\left[\frac{2d}{\sqrt{2}}-
 \frac{1}{2}\left(\frac{1}{u\supTM}-u\supTM\right)\left(\dfrac{\chi}{\xi(p^2+\chi)p}\right)\right],
\end{align}
and 
\begin{equation}
u\supTM =  \frac{(1+\chi)p-\sqrt{p^2 + \chi}}{(1+ \chi)p+\sqrt{p^2+\chi}},
...
% \frac{u\supTM^2e^{-2u p}}{1-u\supTM^2e^{-2u p}}\left[2d- \left(\frac{1}{u\supTM}-u\supTM\right)\dfrac{\chi d}{u(p^2+\chi)p}\right]\\
=&  C\frac{\sqrt{2}}{d^3}\int_1^\infty dp (p^2-1)\int_0^\infty du\,u^{3} 
 \frac{u\supTM_1u\supTM_2e^{-2u p}}{1-u\supTM_1u\supTM_2e^{-2u p}}\left[1- \left(\frac{1}{u\supTM}-u\supTM\right)\dfrac{\chi }{2u(p^2+\chi)p}\right],
\end{align}
and 
\begin{equation}
u\supTM =  \frac{(1+\chi)p-\sqrt{p^2 + \chi}}{(1+ \chi)p+\sqrt{p^2+\chi}},
...
\begin{align}
\frac{d}{dp}\ln[1-u\supTM_1u\supTM_2 e^{-2pu}] %=& \frac{-2u\supTM \frac{du\supTM}{dp} e^{-2pu} + 2u u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}} \\
% &= \frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left( 2u -\frac{2}{u\supTM} \frac{du\supTM}{dp}\right)\\
% &= 2u\frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left( 1 -\frac{1}{uu\supTM} \frac{du\supTM}{dp}\right)\\
&= 2u\frac{u\supTM_1u\supTM_2 e^{-2pu}}{1-u\supTM_1u\supTM_2 e^{-2pu}}\left( 1 -\frac{1}{u} \frac{d\ln[u\supTM]}{dp}\right)
\end{align}
Now use 
\begin{align}
\frac{d}{dp}\ln[u\supTM] =& \frac{d}{dp}\left(\log[e^{2\Xi}p - \sqrt{p^2+\chi}] -\ln[e^{2\Xi}p + \sqrt{p^2+\chi}]\right) \\
...
Then 
\begin{align}
\frac{d}{dp}\ln[1-u\supTM_1u\supTM_2 e^{-2pu}] &= 
2u\frac{u\supTM_1u\supTM_2 e^{-2pu}}{1-u\supTM_1u\supTM_2 e^{-2pu}}\left( 1 -\frac{2\chi e^{2\Xi}}{u\sqrt{p^2+\chi}[e^{4\Xi}p^2-(p^2+\chi)]}\right)\label{eq:TM_integration_by_parts}
\end{align}

% % Ultimately, we want this to be proportional to 
%  \begin{align}
%  C=&\frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left[1 - \left(\frac{1}{u\supTM}-u\supTM\right)\dfrac{\chi }{2u(p^2+\chi)p}\right]\\
% % =&\frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left[1 - \left(\frac{e^{2\Xi}p+\sqrt{p^2+\chi}}{e^{2\Xi}p-\sqrt{p^2+\chi}}
% % -\frac{e^{2\Xi}p-\sqrt{p^2+\chi}}{e^{2\Xi}p+\sqrt{p^2+\chi}}\right)\dfrac{\chi }{2u(p^2+\chi)p}\right]\\
% % =&\frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left[1 - \frac{4pe^{2\Xi}\sqrt{p^2+\chi}}{e^{4\Xi}p^2-(p^2+\chi)}\dfrac{\chi }{2u(p^2+\chi)p}\right]\\
%  =&\frac{u\supTM^2 e^{-2pu}}{1-u\supTM^2 e^{-2pu}}\left[1 - \frac{2\chi e^{2\Xi}}{u\sqrt{p^2+\chi}[e^{4\Xi}p^2-(p^2+\chi)]}\right]\label{eq:CTM}\\
%  \end{align}
% % So this will work.  
...
\begin{align}
I_2 =& \int_1^\infty dp\, (p^2-1) \frac{u\supTM_1u\supTM_2e^{-2u p}}{1-u\supTM_1u\supTM_2e^{-2u p}}
\left[1- \left(\frac{1}{u\supTM}-u\supTM\right)\dfrac{\chi }{2u(p^2+\chi)p}\right]\\
=& \left[(p^2-1)\frac{1}{2u}\log[1-u\supTM_1u\supTM_2 e^{-2pu}]\right]_{p=1}^\infty - \int_1^\infty dp\,\frac{p}{u}\log[1-u\supTM_1u\supTM_2 e^{-2pu}]
\end{align}
Which gives us 
\begin{align}
\Aboxed{E_{TM}= & \frac{\hbar c}{8\pi^2 }\int_0^\infty d\xi\,\xi^{2} \int_1^\infty dp\, p \log[1-u\supTM_1u\supTM_2 e^{-2p\xi d}]}
\end{align}
...
to capture the near-field and extreme far-field behaviour.
...
The fact that all material functions are already in the exponent suggests that this is the most natural
way to discuss Casimir phenomena in the worldline.  
Second, in the TE polarization the potential is proportional to $s_n^2$.
 In contrast, in the TM polarization the additional TM potential is not weighted by $s_n$---the TM 
potential might depend on the frequency via $\epsr(\vect{x},is_n)$,
but it is not explicitly weighted by it.
 This has important ramifications for the near-field and 
high temperature limits.  In those limits, the entire effect is provided by the TM polarization.  

At high temperature $\beta\rightarrow 0$, so the spacing between the Matsubara frequencies $s_n=2\pi n/(\hbar \beta)$
diverges.  As a result, only the first and zero frequency mode significantly contribute.  In fact, the 
first mode is exponentially suppressed relative to the zero frequency mode.  
...
There has been a dispute over the correct model
for the frequency dependence of a realistic metal.  The Drude model diverges as $\omega^{-1}$ at DC,
...
unable to distinguish between the two models, although Sushkov~\etal measurements are claimed to have eliminated the 
...
The sum over Matsubara modes, can be converted into a frequency integral 
...
Let us now consider the various limits for the Casimir-Polder case.  The presence of the worldline
can be used to estimate the relevant frequencies.  
...
Secondly, the frequency sum is dominated by the exponential factors,
 which will contribute most when $\cT\omega_n^2/c^2\sim 1$.
 This suggests that frequencies with  $\omega_n^2< c^2/d^2$  will contribute most to the Casimir energy.   

\subsubsection{Near field, low temperature}
Now consider a limit where the separation is much smaller than the dominant wavelength, 
 $d\ll c/\omega_{j0}$.
 In this case all frequencies contribute, but the sum can be converted into an integral.
 And in distinction to the far-field limit, here the frequency dependence of $\epsilon(\omega)$ will matter.  
\begin{equation}
E-E_0=-\frac{\hbar}{8\pi^2\epsilon_0c^3}\int_0^\infty d\omega\,\omega^3\alpha(i\omega)
...
%& \frac{ p + \frac{\chi}{2p}-p}{2p+\frac{\chi(i\omega)}{2p}} 
\approx \frac{\chi(i\omega)}{4p^2}.
\end{align}
After substituting this in, the $p$ integral is
% \begin{align}
...
Recall, we are working in the so-called near-field limit where $\omega_{j0}d/c<<1.$  
...
\end{align}
Since I think we are working with $d\omega/c$ is very small, so this term is tiny.  
...
&\times\dlangle \frac{\omega^2}{c^2}e^{-\cT\frac{\omega^2}{2c^2}}-\left(\frac{\omega^2}{c^2} 
 - \frac{1}{2}\partial_x^2\right)e^{-\frac{ \cT \omega^2\langle\epsilon(i\omega)\rangle}{2c^2} - \cT\langle V_{TM}(i\omega)\rangle}\drangle\label{eq:TM_CP_zero_temperature},
\end{align}
...
\begin{align}
E-E_0=& -k_BT{\sum_n}'\frac{\alpha(i\omega_n)}{2\epsilon_0}\int_0^\infty d\cT\,
\frac{1}{(2\pi \cT)^{3/2}}\left(\frac{\omega_n^2}{c^2}  - \frac{1}{2}\partial_x^2\right)
\dlangle e^{-\cT\frac{\omega_n^2}{2c^2}}-e^{-\frac{ \cT \omega_n^2\langle\epsilon(i\omega_n)\rangle}{2c^2} - \cT\langle V_{TM}\rangle}\drangle \\
...
% \begin{equation}
% F-F_0=-\beta^{-1}{\sum_n}'\frac{\alpha(i\omega_n)}{2\epsilon_0}\int_0^\infty d\cT\,
% \frac{1}{(2\pi \cT)^{3/2}}\dlangle \frac{\omega_n^2}{c^2}e^{-\cT\frac{\omega_n^2}{2c^2}}-\left(\frac{\omega_n^2}{c^2}  
% - \frac{1}{2}\partial_x^2\right)e^{-\frac{ \cT \omega_n^2\langle\epsilon(i\omega_n)\rangle}{2c^2} - \cT\langle V_{TM}\rangle}\drangle
% \end{equation}
In the high temperature limit, only the zero frequency term contributes, so the Casimir--Polder
energy is  
\begin{equation}
F-F_0=-\frac{1}{2}\beta^{-1}\frac{\alpha(0)}{2\epsilon_0}\int_0^\infty d\cT\,\frac{1}{(2\pi \cT)^{3/2}}
...
% \begin{align}
% \dlangle e^{-\int_0^\cT dt V_{TM}}\drangle &= 1 + \frac{\sinh(\Xi/2)}{\cosh\Xi}[e^{\Xi/2} + e^{-\Xi/2}]e^{-2 d^2/\cT}\\
...
% &= 1 + \frac{\epsilon(0) - 1}{\epsilon(0)+1}e^{-2 d^2/\cT}.
% \end{align}
