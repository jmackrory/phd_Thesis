...
The atom is located at $\xA$, and has polarizability $\alpha$ and magnetizability $\beta$.
The atom is interacting with a fixed background permittivity $\epsr(\vect{x})$, and permeability $\mur(\vect{x})$.
...
\begin{equation}
  ...
  \end{equation}
The Casimir--Polder energy comes from expanding the free energy to linear order in the $\alpha$ and $\beta$.
This expansion corresponds to extracting the lowest order linear response.
The expansion must be carried out in both the path-averaged speed of light, and the potential $V\subTE$.
...
These considerations suggest that in order to extract the energy for a polarizing an atom, one should take the 
following functional derivatives...



We can try to handle the atom-body case by taking $\epsilon \rightarrow \epsilon + \alpha\delta(\vect{x}-\xA)$.
