...
the Casimir--Polder energy~(\ref{eq:TECP_interp}), while taking $D=4, \alpha=3/2$ yields
\begin{align}
...
\begin{align}
  ...
  \int_1^\infty dv\,v^{-4}(1-2v^2)  \frac{ ve^{2\Xi}-\sqrt{v^2+\chi}} {v e^{2\Xi}+\sqrt{v^2+\chi}}
\end{align}
