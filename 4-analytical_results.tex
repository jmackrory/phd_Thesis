...
% On the imaginary frequency axis, the dielectric functions
...
\end{align}
In the last line we have factored out the normalization for a $n$-dimensional Brownian bridge $\cT^{n/2}$.
