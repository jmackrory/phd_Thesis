...
The worldline Casimir energies will be rewritten in the right form to use the solutions from chapter~\ref{ch:feynman_kac}.  
...
% As discussed in \citep[\S 4.7]{Jackson1998}, the electrostatic energy for a system depends on the 
...
see Eq.~(14.210) in \S 14.3 of \citet{SteckNotes}\,].
