...
I_{tot}% -I_1-I_2 + I_0 
=& 
  \frac{2u\supTM_1u\supTM_2 e^{-\sqrt{2\lambda}d}d}{\sqrt{2\lambda}(1-u\supTM_1u\supTM_2 e^{-2\sqrt{2\lambda}d})} 
...
+ \frac{u\supTM_2}{4(\lambda+\chi_)2}\right)\frac{u\supTM_1u\supTM_2 e^{-2\sqrt{2\lambda}d}}{(1-u\supTM_1u\supTM_2 e^{-2\sqrt{2\lambda}d})},
\end{align}
where $\kappa = \lambda+\chi$, and 
\begin{equation}
u\supTM =  \frac{\epsilon\sqrt{\lambda}-\sqrt{\kappa}}{\epsilon\sqrt{\lambda}+\sqrt{\kappa}}
\end{equation}
