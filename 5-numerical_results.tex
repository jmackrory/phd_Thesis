...
\begin{figure}
 ...
 \includegraphics[width=0.8\textwidth]{fig/temp/eff_TE_atom_wall}
  \caption{\comment{TEMPORARY!} Convergence planar Casimir--Polder energy as function of $\chi$}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{fig/temp/eff_TE_2wall}
  \caption{\comment{TEMPORARY!} Convergence planar Casimir energy as function of $\chi$}
\end{figure}
...
\begin{figure}
  ...
  \caption{\comment{TEMPORARY!} Convergence of planar Casimir--Polder energy  as function of $N$}
\end{figure}
...
\begin{figure}
  ...
  \caption{\comment{TEMPORARY!} Convergence planar Casimir energy as function of $N$}
\end{figure}
