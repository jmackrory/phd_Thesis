...
path-averaged exponential~(\cite{eq:TMpot}) in generating increments.  The resulting 
...
then we would expect $\log \omega_k$ to be normally distributed, with some variance. 
...
which contribute little to the Casimir energy.  A few rare paths would skirt outside the surface, accumulating
