...
constructing Brownian paths, and Monte Carlo sampling of the path starting points $x_0$
...
[Inversion is a general purpose method of generating random deviates from a given distribution~\citep[\S7.2]{NumRecipe}.]
...
and accepted with a probability $P_2(x)/P_1(x)$, where  $P_2$ is the ``target'' distribution~\citep[\S7.3]{NumRecipe}.
