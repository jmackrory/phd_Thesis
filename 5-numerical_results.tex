...
or ``d-loops'' [which start with a coarse path, and then refine the path by doubling the number of points~\citep{Gies2005}]
...
is formally discussed by \citet{Nualart2006}, \citet{Malliavin2006}, and \cite{DiNunno2009}.
