...
The threshold $m$ can be estimated based on how likely the path of a given timestep is to touch 
...
\begin{align}
  ...
  \partial_0^n [U(x_0,x_m,\cT_m) U(x_0,x_{N-m},\cT_m]\prod_{j=m}^{N-m-1}U(x_{j+1},x_j,\Delta \cT)
   \biggdrangle.
\end{align}
In this case, the derivatives act on the whole propagator~\ref{eq:Upropator}, rather than just the Gaussian parts.  
