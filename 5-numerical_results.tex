...
The most daunting feature of the TM Casimir worldline is the singular TM potential~(\ref{eq:VsubTM}).
...
\begin{figure}
  ...
  {Histogram of accumulated numerical TM estimates, for raw Gaussian (blue) and birth-death Gaussian (red).
    Calculations used $10^6$ paths, with $N=100$ points per path, $\chi=100$, $d=1,T=1.$
