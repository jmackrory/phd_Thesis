...
While the general-$\chi$ coupling integrand leads to the correct answer in the strong-coupling limit once enough
...
occupation time (which will capture general $\chi$), and also isolate a subset of paths which just touch the 
...
An alternative method to the one presented in Section~(\ref{eq:generic_coupling}),  one more suited to the strong-coupling limit, 
...
% The second term can be sampled using the generic coupling algorithm from Section~\ref{sec:direct_construct}.
